...
if(num!= null){//입력된 번호가 있다면 
	...
	try{
		...
		if(obj==null){
			bs.modifyBoardCnt(tempNum);//세션에 값이 없을때에만 카운트를 올림.
		//해당 글번호의 글을 읽었음을 저장
		}
...
<div class="row featurette">
	<div class="col-md-7">
		...
		<input type="hidden" name="num" value="${ param.num }">
			<button onclick="return false" class="btn btn-success" id="btnModify">글 수정</button>
			<button onclick="return false" class="btn btn-success" id="btnDelete">글 삭제</button>
		</c:if>
